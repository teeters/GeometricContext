...
imdir = '/home/teeters/Documents/Classes/computer_vision/final_project/GeometricContext/src/dataset';
outdir = '/IUS/vmr20/dhoiem/data/ijcv06';
ncv = 5;

if 0
    load 'src/dataset/rand_indices.mat'
    load 'src/dataset/allimsegs2.mat'
